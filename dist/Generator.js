;(function (global, factory) {
    ...
    var uncurryThisWithBind =
        functionBindNative && FunctionPrototype$1.bind.bind(call$1, call$1)
    ...
    var wellKnownSymbol = function (name) {
        if (
            ...
            if (
                symbolConstructorDetection &&
                hasOwnProperty_1(Symbol$1, name)
            ) {
    ...
    var classof = toStringTagSupport
        ...
        : function (it) {
              ...
              return it === undefined
                  ...
                  ? 'Null'
                  : // @@toStringTag case
                  typeof (tag = tryGet((O = $Object$2(it)), TO_STRING_TAG$1)) ==
                    'string'
                  ? tag
                  : // builtinTag case
                  CORRECT_ARGUMENTS
  ...
  */
    ...
    var AbstractTask_1 = createCommonjsModule(function (module, exports) {
        ...
        var AbstractTask = /** @class */ (function () {
            ...
            AbstractTask.prototype.process = function (params, options) {
                ...
                return (_a = this.nextTask) === null || _a === void 0
                    ? void 0
                    : _a.process(params, options)
            }
            return AbstractTask
        })()
    ...
    var TaskChain_1 = createCommonjsModule(function (module, exports) {
        ...
        var TaskChain = /** @class */ (function () {
            ...
            TaskChain.prototype.processChain = function () {
                var _a
                return (_a = this.entryPoint) === null || _a === void 0
                    ? void 0
                    : _a.process(this.parameters, this.options)
            }
            return TaskChain
        })()
    ...
    var src = createCommonjsModule(function (module, exports) {
        ...
        Object.defineProperty(exports, 'TaskChain', {
            enumerable: true,
            get: function () {
                return TaskChain_1.TaskChain
            }
        })

        Object.defineProperty(exports, 'AbstractTask', {
            enumerable: true,
            get: function () {
                return AbstractTask_1.AbstractTask
            }
        })
    })
    ...
    var removeNodes = function removeNodes(node) {
        ...
        if (node instanceof NodeList && node.length) {
            node.forEach(function (currentNode) {
                ...
                return (_currentNode$parentNo = currentNode.parentNode) ===
                    null || _currentNode$parentNo === void 0
                    ? void 0
                    : _currentNode$parentNo.removeChild(currentNode)
            })
        }
    }
    ...
    var functionBind = functionBindNative
        ? $Function.bind
    ...
    function getText() {
        var _this$$selected
        return getTextElem(
            (_this$$selected = this.$selected) !== null &&
    ...
    var NoElementSelectedError = /*#__PURE__*/ (function (_BaseError) {
        ...
        function NoElementSelectedError() {
            ...
            Object.setPrototypeOf(
                _assertThisInitialized(_this),
                NoElementSelectedError.prototype
            )
            return _this
        }
    ...
    var NoElementSpecifiedError = /*#__PURE__*/ (function (_BaseError) {
        ...
        function NoElementSpecifiedError() {
            ...
            Object.setPrototypeOf(
                _assertThisInitialized(_this),
                NoElementSpecifiedError.prototype
            )
            return _this
        }
    ...
    var isArrayIteratorMethod = function (it) {
        return (
            it !== undefined &&
            (iterators.Array === it || ArrayPrototype[ITERATOR$4] === it)
        )
    }
                ...
                if (element instanceof Node) {
                    ...
                    parent === null || parent === void 0
                        ...
                        : parent.replaceChildren.apply(
                              parent,
                              _toConsumableArray(Array.from(element))
                          )
    ...
    var GeneratorJs = /*#__PURE__*/ (function () {
        ...
        function GeneratorJs(definitions) {
            ...
            if (!definitions || !isPlainObject(definitions)) {
                throw new TypeError(
                    'Element passed to constructor must be an object! '.concat(
                        _typeof(definitions),
                        ' is given!'
                    )
                )
        ...
        _createClass(GeneratorJs, [
            ...
            },
            {
                ...
                value: function getFragment() {
                    if (
                        this.$fragment &&
                        this.$fragment instanceof DocumentFragment
                    ) {
